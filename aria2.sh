...
dhtfile="https://raw.githubusercontent.com/bydvoid/Shells/master/repo/files/dht.dat"
aria2servicefile="https://raw.githubusercontent.com/bydvoid/Shells/master/repo/files/services/aria2.service"
updatebtsh="https://raw.githubusercontent.com/bydvoid/Shells/master/repo/sh/updatebt.sh"

# 判断架构
bit=`uname -m`
if [[ ${bit} == "x86_64" ]]; then
	bit="64bit"
	aria2file="https://raw.githubusercontent.com/bydvoid/Shells/master/repo/files/aria2-1.34.0-linux-gnu-64bit-build1.tar.bz2"
	aria2dirname="aria2-1.34.0-linux-gnu-64bit-build1"
	aria2conf="https://raw.githubusercontent.com/bydvoid/Shells/master/repo/files/config/aria2nas.conf"
elif [[ ${bit} == "i386" || ${bit} == "i686" ]]; then
	bit="32bit"
	aria2file="https://raw.githubusercontent.com/bydvoid/Shells/master/repo/files/aria2-1.34.0-linux-gnu-32bit-build1.tar.bz2"
	aria2dirname="aria2-1.34.0-linux-gnu-32bit-build1"
	aria2conf="https://raw.githubusercontent.com/bydvoid/Shells/master/repo/files/config/aria2nas.conf"
else
	bit="arm"
	aria2conf="https://raw.githubusercontent.com/bydvoid/Shells/master/repo/files/config/aria2t1.conf"
fi
